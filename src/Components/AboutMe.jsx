...
function AboutMe() {
  return (
    <div className="h-[680px] text-white mt-8">
      ...
      <div className="flex items-start justify-center gap-20 h-[460px] mt-2">
        <div className="mt-6 w-[16%] flex justify-center h-[100%]">
          <img className="h-[400px] rounded-lg" src={profilepic} alt="" />
        </div>
        <div className="w-[55%] h-[100%]  text-[22px] font-light text-zinc-200 flex flex-col gap-3 justify-around">
